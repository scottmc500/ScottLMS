...
def validate_password(
    password, username=None, first_name=None, last_name=None, email=None
):
    """
    ...
    if re.search(
        ...
        errors.append(
            "Password should not contain sequential characters (123, abc, etc.)"
        )
...
def display_inline_password_requirements(
    password, username=None, first_name=None, last_name=None, email=None
):
...
def display_password_requirements_checklist(
    password, username=None, first_name=None, last_name=None, email=None
):
    ...
    with col2:
        ...
        if (
            ...
            and first_name.lower() in password.lower()
        ):
    ...
    if score < 30:
        ...
        st.progress(progress)
        st.markdown(
            "⚠️ **This password could be stronger. Consider adding more complexity.**"
        )
    elif score < 80:
