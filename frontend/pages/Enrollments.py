...
from frontend.components.forms import create_enrollment_form
from frontend.components.tables import display_enrollments
...
# Header
st.markdown('<h1 class="main-header">🎯 Enrollment Management</h1>', unsafe_allow_html=True)
