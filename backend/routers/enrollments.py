...
from entities.enrollments import Enrollment, EnrollmentCreate, EnrollmentUpdate, EnrollmentResponse
...
async def create_enrollment(enrollment_data: EnrollmentCreate):
    ...
    try:
        ...
        logger.info(f"Created enrollment: User {enrollment.user_id} in Course {enrollment.course_id}")
