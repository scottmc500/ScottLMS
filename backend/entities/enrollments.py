...
class EnrollmentBase(BaseModel):
    ...
    progress: float = Field(default=0.0, ge=0, le=100, description="Course completion percentage")
...
class EnrollmentUpdate(BaseModel):
    ...
    progress: Optional[float] = Field(None, ge=0, le=100, description="Course completion percentage")
